...
## Environments
- Preview: https://main--aratest--ujjawalhlab.aem.page/
- Live: https://main--aratest--ujjawalhlab.aem.live/
...
1. Open the `aratest` directory in your favorite IDE and start coding :)
